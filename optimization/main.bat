...
SET version=7.2.0
title Performance and Optimization v%version%
echo root@: %username%. Gtxovt Gamoiyenet Gilaki 'ENTER'
pause
:-------------------------------------
...
:: https://github.com/ / s-optimization-Batch/blob/1cd729188505543b75abd01e7f891d9148b19a71/ %20AIO.bat#L109
@powershell -ExecutionPolicy Bypass -Command "Checkpoint-Computer -Description 'Before  ' -RestorePointType 'MODIFY_SETTINGS'"
